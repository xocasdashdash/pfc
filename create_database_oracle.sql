CREATE TABLE UAH_GAT_Enrollment (id NUMBER(10) NOT NULL, 
...
idApplication NUMBER(10) DEFAULT NULL, 
PRIMARY KEY(id));
CREATE INDEX UAH_GAT_IDX_AD0C83B61335E2FC ON UAH_GAT_Enrollment (activityId);
CREATE INDEX UAH_GAT_IDX_AD0C83B6E40622B9 ON UAH_GAT_Enrollment (idApplication);
CREATE TABLE UAH_GAT_Degree (id NUMBER(10) NOT NULL, 
name VARCHAR2(255) NOT NULL, 
knowledgeArea VARCHAR2(255) NOT NULL, 
academicCode VARCHAR2(255) NOT NULL, 
PRIMARY KEY(id));
CREATE TABLE UAH_GAT_Activity (id NUMBER(10) NOT NULL, 
...
degreeId));
CREATE INDEX UAH_GAT_IDX_C8C9E83B1335E2FC ON UAH_GAT_Activity_Degree (activityId);
CREATE INDEX UAH_GAT_IDX_C8C9E83B576EC1D0 ON UAH_GAT_Activity_Degree (degreeId);
CREATE TABLE UAH_GAT_User (id NUMBER(10) NOT NULL, 
name VARCHAR2(255) NOT NULL, 
...
PRIMARY KEY(id));
CREATE INDEX UAH_GAT_IDX_8D0E506576EC1D0 ON UAH_GAT_User (degreeId);
...
CREATE TABLE UAH_GAT_Application (id NUMBER(10) NOT NULL, 
...
PRIMARY KEY(id));
CREATE INDEX UAH_GAT_IDX_5122C9C264B64DCC ON UAH_GAT_Application (userId);
CREATE TABLE UAH_GAT_Role (id NUMBER(10) NOT NULL, 
...
ALTER TABLE UAH_GAT_Enrollment ADD CONSTRAINT UAH_GAT_FK_AD0C83B61335E2FC FOREIGN KEY (activityId) REFERENCES UAH_GAT_Activity (id);
ALTER TABLE UAH_GAT_Enrollment ADD CONSTRAINT UAH_GAT_FK_AD0C83B6E40622B9 FOREIGN KEY (idApplication) REFERENCES UAH_GAT_Application (id);
ALTER TABLE UAH_GAT_Activity ADD CONSTRAINT UAH_GAT_FK_FA8719199D47173 FOREIGN KEY (organizer) REFERENCES UAH_GAT_User (id);
ALTER TABLE UAH_GAT_Activity_Degree ADD CONSTRAINT UAH_GAT_FK_C8C9E83B1335E2FC FOREIGN KEY (activityId) REFERENCES UAH_GAT_Activity (id);
ALTER TABLE UAH_GAT_Activity_Degree ADD CONSTRAINT UAH_GAT_FK_C8C9E83B576EC1D0 FOREIGN KEY (degreeId) REFERENCES UAH_GAT_Degree (id);
ALTER TABLE UAH_GAT_User ADD CONSTRAINT UAH_GAT_FK_8D0E506576EC1D0 FOREIGN KEY (degreeId) REFERENCES UAH_GAT_Degree (id);
...
ALTER TABLE UAH_GAT_Application ADD CONSTRAINT UAH_GAT_FK_5122C9C264B64DCC FOREIGN KEY (userId) REFERENCES UAH_GAT_User (id);
