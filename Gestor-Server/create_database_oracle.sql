CREATE TABLE UAH_GAT_ApplicationForm (id NUMBER(10) NOT NULL, applicationDate TIMESTAMP(0) NOT NULL, applicationFile BLOB NOT NULL, verificationCode VARCHAR2(255) NOT NULL, isProcessed NUMBER(1) NOT NULL, userId NUMBER(10) DEFAULT NULL, PRIMARY KEY(id));
CREATE INDEX UAH_GAT_PK_IDX_B5EFE7164B64DCC ON UAH_GAT_ApplicationForm (userId);
CREATE TABLE UAH_GAT_BasicRegistration (id NUMBER(10) NOT NULL, dni VARCHAR2(255) NOT NULL, dateProcessed TIMESTAMP(0) NOT NULL, dateRegistered TIMESTAMP(0) NOT NULL, isProcessed NUMBER(1) NOT NULL, recognizedCredits DOUBLE PRECISION DEFAULT NULL, creditsType DOUBLE PRECISION DEFAULT NULL, activityId NUMBER(10) NOT NULL, idApplicationForm NUMBER(10) DEFAULT NULL, PRIMARY KEY(id));
...
CREATE TABLE UAH_GAT_Activity (id NUMBER(10) NOT NULL, organizer NUMBER(10) NOT NULL, name VARCHAR2(500) NOT NULL, englishName VARCHAR2(500) NOT NULL, numberOfECTSCreditsMin DOUBLE PRECISION NOT NULL, numberOfECTSCreditsMax DOUBLE PRECISION NOT NULL, numberOfCreditsMin DOUBLE PRECISION NOT NULL, numberOfCreditsMax DOUBLE PRECISION NOT NULL, isPublic NUMBER(1) NOT NULL, celebrationDates CLOB NOT NULL, hasAdditionalWorkload NUMBER(1) NOT NULL, numberOfHours DOUBLE PRECISION NOT NULL, assistanceControl VARCHAR2(255) NOT NULL, publicityStartDate DATE NOT NULL, registrationManagement NUMBER(1) NOT NULL, extraInformationFile BLOB NOT NULL, url VARCHAR2(255) NOT NULL, slug VARCHAR2(255) NOT NULL, numberOfPlacesOffered NUMBER(10) NOT NULL, numberOfPlacesOccupied NUMBER(10) NOT NULL, approvedByComitee NUMBER(1) NOT NULL, isActive NUMBER(1) NOT NULL, cost DOUBLE PRECISION NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE UAH_GAT_Activity_Degree (activityId NUMBER(10) NOT NULL, degreeId NUMBER(10) NOT NULL, PRIMARY KEY(activityId, degreeId));
...
CREATE TABLE UAH_GAT_User (id NUMBER(10) NOT NULL, name VARCHAR2(255) NOT NULL, email VARCHAR2(255) DEFAULT NULL, type VARCHAR2(255) DEFAULT NULL, password VARCHAR2(255) NOT NULL, creationIp VARCHAR2(255) DEFAULT NULL, uahName VARCHAR2(255) DEFAULT NULL, degreeId NUMBER(10) DEFAULT NULL, PRIMARY KEY(id));
